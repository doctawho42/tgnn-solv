...
% it frees 4.44pt in every column whose widest cell is a `a +- b' (three of the four there), which
% is what pays for the wider gutter.  DO NOT use it in prose -- `mean $\pm$ s.d.' in a block head is
