...
earth-mover term is the grounding term whose \emph{absence} in the end-to-end arm the paradox exploits.
...
For a diagnostic result the elaborate objective is a liability: it invites the reading that the paradox
...
not the auxiliary terms. \pending[minimal-loss paradox sign + surrogate drift: GCP L4 run queued behind the 2x2 test]
