...
kernel a typed three-profile base produces a silently-wrong result, worth documenting because the
...
that the overall symptom is loss-robust, not subset-level confirmation of the mechanism. It is
