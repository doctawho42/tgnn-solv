...
\paragraph{Crystal-term decodability (Study 1a).} Probe fitted on $152$ solutes / $14{,}348$ rows,
...
Two features of this table are worth stating because they bear on how such probes should be
read. First, the between-seed spread ($0.616$ range, sd $0.334$) exceeds every individual value:
a single-seed run would have been unreadable, and seed $43$ alone would have looked like a
near-miss worth pursuing. Second, a decision rule of the common form
...
\paragraph{Temperature structure (Study 2).} Slopes are fitted at fixed (solute, solvent); a slope
...
\paragraph{Organisation of the representation (Study 4).} Excess over a permutation null matched
...
$13.6/8.2/4.7\%$, TPSA $9.0/10.3/7.1\%$, MolWt $5.3/2.3/3.1\%$.
...
any solute-level variable shares variance with it in sample; Study 1a asks the different and
