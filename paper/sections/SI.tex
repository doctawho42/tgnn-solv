...
$0.88$ (ridge); since the true $\Binsuf$ lies below the smallest valid upper bound and
...
strength is estimator-dependent---consistent with the solvent-clustered $P(\Bclos>\Binsuf)\approx0.85$
(hedge~3).

\paragraph{In-regime ($\gamma$-stratified) separation.} The keystone is matched at low $\gamma$,
...
$\Binsuf\le0.3$ by an order of magnitude. This supports (does not prove) the conjecture that the
same closure misspecification drives the all-$\gamma$ paradox.
