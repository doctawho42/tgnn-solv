...
solutes) the sign in fact reverses ($-0.23$ minimal vs $+0.22$ full), so we read the ablation as evidence
that the overall symptom is loss-robust, not as subset-level confirmation of the mechanism. It is
