...
closure misspecification $\Bclos=0.6$ ($[0.3,0.8]$, a stratified within-scaffold molecule bootstrap). $\Binsuf$ is stated as a value here,
and as a bound everywhere else, because only here is it measured (see the resolution note in \S\ref{sec:decomp}). This is the
...
untuned control; the load-bearing second-domain results are the decomposition above and the certified
flip.
