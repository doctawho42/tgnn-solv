...
$g(\hammett)=\mathrm pK_{a,0}-\rho\,\hammett$ over the Hammett substituent constant \hammett, written
with its subscript throughout so that it cannot be confused with the $\sigma$-profile of
...
all four series, gap $90\%$ CI $[{+}0.57,{+}0.95]$): the freely learned $\hat\sigma_{\mathrm H}$ absorbs the ortho/steric
...
reverting to helps only under scaffold \emph{extrapolation}, where $\hat\sigma_{\mathrm H}$ breaks ($2.6{\pm}2.0$)
