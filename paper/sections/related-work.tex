...
The broader question of when a fixed physical structure improves or degrades a learned model is central to
...
neural-solver work has a fixed operator but only a numerical, unreferenced error term. We supply what
is missing: an external reference for the learned intermediate---a reference $\sigma$-profile
...
the accuracy reference points for this task.
