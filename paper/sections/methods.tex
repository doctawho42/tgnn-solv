...
\S\ref{sec:measure} are named there with the script and the artifact file of each; not every artifact
those scripts read is small enough to version, and the larger ones are deposited separately
(limitation~(x), \S\ref{sec:discussion}).
