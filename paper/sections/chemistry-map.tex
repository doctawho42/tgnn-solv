...
The solute axis shows a compatible but weaker pattern (Table~\ref{tab:solute-map}). The closure costs most on ordinary neutral organics---oxygenated solutes, polyaromatics, and heterocycles---while an earlier hypothesis, that it should hurt most on charged, high-$|\lng|$ solutes such as salts, did not replicate once the split was corrected: the charged/salt stratum is neutral. The clean penalty falls on neutral organics, not on the ionic tail we had expected to be hardest.
