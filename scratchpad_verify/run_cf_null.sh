...
~/anaconda3/envs/tgnn-solv/bin/python scripts/analysis/run_b_insuff_crossfit_scoring.py --stage null --null-draws 2000 > $SP/cf_null.txt 2>&1
echo "EXIT=$?" >> $SP/cf_null.txt
