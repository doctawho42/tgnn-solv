...
def test_pretrain_mask_alignment(monkeypatch):
    ...
    def fake_smiles_to_graph(_smi):
        return base_graph.clone()

    def fake_compute_properties(_smi):
